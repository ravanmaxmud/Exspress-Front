function getems() {
    ...
    document.querySelector('.placedrop').innerHTML = n
...
function showSwict() {
    ...
    if (karts.length === 0) {
        document.querySelector('.whichstatement').classList.remove('d-none')
    } else {
        document.querySelector('.whichstatement').classList.add('d-none')
    }
}
showSwict()